...
if wget -q https://github.com/Brashkie/BrashkieBot-KING/raw/master/musicSH/"$random_mp3"; then
...
echo -e "\033[01;33mpkg install git -y\npkg install nodejs -y\npkg install ffmpeg -y\npkg install imagemagick -y\npkg install -y yarn\ngit clone https://github.com/Brashkie/BrashkieBot-KING\ncd BrashkieBot-KING\nyarn install\nnpm install\nnpm start\033[0m"
exit 1
else
...
echo -e "\033[1;35m"
git clone https://github.com/Brashkie/BrashkieBot-KING.git
...
echo -e "\033[01;32m\033[01mIniciando Brashkie!!\nStarting BrashkieBot!!\n\033[0m"
npm run qr
